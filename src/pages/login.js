...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center",
      ...
      <div style={{ background:"#fff", borderRadius:24, padding:"2.5rem 2rem",
        ...
        <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize:"1.9rem",
          color:"#1a1a1a", margin:"0 0 .3rem" }}>POPPYPINK</h1>
        ...
        <button onClick={() => signIn("google", { callbackUrl })}
          style={{ width:"100%", padding:".85rem", borderRadius:12,
        ...
        {/* Tabs */}
        <div style={{ display:"flex", background:"#f7f7f7", borderRadius:10,
          padding:3, marginBottom:"1.25rem" }}>
          {["login","register"].map(t => (
            <button key={t} onClick={() => { setTab(t); setErr(""); }}
              style={{ flex:1, padding:".55rem", border:"none", cursor:"pointer",
        ...
        <form onSubmit={handleCredentials}
          ...
          <div>
            <label style={{ fontSize:".78rem", fontWeight:700, color:"#555",
              display:"block", marginBottom:".3rem" }}>Email</label>
            <input type="email" required value={email}
              onChange={e => setEmail(e.target.value)}
              placeholder="you@email.com"
              style={{ width:"100%", padding:".7rem .9rem", borderRadius:10,
          ...
          <div>
            <label style={{ fontSize:".78rem", fontWeight:700, color:"#555",
              display:"block", marginBottom:".3rem" }}>Password</label>
